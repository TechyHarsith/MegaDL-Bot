...
async def help(bot, message, cb=False):
    ...
    button = [[
        ...
        InlineKeyboardButton(f'📦 SOURCE', url='https://github.com/TechyHarsith/MegaDL-Bot'),
    ...
    if Config.UPDATES_CHANNEL:
        ...
        try:
            ...
            if user.status == "kicked":
                await message.message.edit(
                    text="Sorry Sir, You are Banned. Contact My [Support Group](https://t.me/TechuuRaV2A).",
                    parse_mode="markdown",
                    disable_web_page_preview=True
                )
                return
            ...
            await message.message.edit(
                text="Something Went Wrong. Contact My [Support Group](https://t.me/TechuuRaV2A).",
                parse_mode="markdown",
                disable_web_page_preview=True
            )
            return
